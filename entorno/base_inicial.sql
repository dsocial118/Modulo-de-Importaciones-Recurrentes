...
--
-- Table structure for table `mir_c1_archivo`
--

DROP TABLE IF EXISTS `mir_c1_archivo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `mir_c1_archivo`
--

LOCK TABLES `mir_c1_archivo` WRITE;
/*!40000 ALTER TABLE `mir_c1_archivo` DISABLE KEYS */;
INSERT INTO `mir_c1_archivo` VALUES (1,'DISP_PENAL','Listado de dispositivos penales',1),(2,'DISP_SCP','Listado de dispositivos de cuidado residencial',1),(3,'MPI','Nómina de medidas de protección integral',1),(4,'MPE','Nómina de medidas de protección excepcional',1),(5,'MPJ_DAE','Nómina de medidas penales juveniles',1),(9,'LEGAJO_NYA','Legajo de niñas, niños y adolescentes',1);
/*!40000 ALTER TABLE `mir_c1_archivo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c1_archivo_version`
--

DROP TABLE IF EXISTS `mir_c1_archivo_version`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c1_archivo_version` (
  ...
  CONSTRAINT `mir_c1_archivo_version_ibfk_1` FOREIGN KEY (`archivo_id`) REFERENCES `mir_c1_archivo` (`id`),
  CONSTRAINT `mir_c1_archivo_version_ibfk_2` FOREIGN KEY (`copiada_de`) REFERENCES `mir_c1_archivo_version` (`id`)
...
--
-- Dumping data for table `mir_c1_archivo_version`
--
...
--
-- Table structure for table `mir_c1_campo`
--

DROP TABLE IF EXISTS `mir_c1_campo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c1_campo` (
  ...
  CONSTRAINT `mir_c1_campo_ibfk_1` FOREIGN KEY (`hoja_id`) REFERENCES `mir_c1_hoja` (`id`),
  CONSTRAINT `mir_c1_campo_ibfk_2` FOREIGN KEY (`dimension_id`) REFERENCES `mir_c1_dimension` (`id`),
  CONSTRAINT `mir_c1_campo_ibfk_3` FOREIGN KEY (`catalogo_id`) REFERENCES `mir_c1_catalogo` (`id`)
...
CREATE TABLE `mir_c1_campo_regla` (
  ...
  CONSTRAINT `mir_c1_campo_regla_ibfk_1` FOREIGN KEY (`campo_id`) REFERENCES `mir_c1_campo` (`id`),
  CONSTRAINT `mir_c1_campo_regla_ibfk_2` FOREIGN KEY (`regla_id`) REFERENCES `mir_c1_regla` (`id`)
...
CREATE TABLE `mir_c1_catalogo_opcion` (
  ...
  CONSTRAINT `mir_c1_catalogo_opcion_ibfk_1` FOREIGN KEY (`catalogo_id`) REFERENCES `mir_c1_catalogo` (`id`)
...
CREATE TABLE `mir_c1_dimension` (
  ...
  CONSTRAINT `mir_c1_dimension_ibfk_1` FOREIGN KEY (`hoja_id`) REFERENCES `mir_c1_hoja` (`id`)
...
CREATE TABLE `mir_c1_hoja` (
  ...
  CONSTRAINT `mir_c1_hoja_ibfk_1` FOREIGN KEY (`archivo_version_id`) REFERENCES `mir_c1_archivo_version` (`id`)
...
CREATE TABLE `mir_c1_regla` (
  ...
  CONSTRAINT `mir_c1_regla_ibfk_1` FOREIGN KEY (`tipo_regla_id`) REFERENCES `mir_c1_tipo_regla` (`id`)
...
CREATE TABLE `mir_c1_tipo_regla_parametro` (
  ...
  CONSTRAINT `mir_c1_tipo_regla_parametro_ibfk_1` FOREIGN KEY (`tipo_regla_id`) REFERENCES `mir_c1_tipo_regla` (`id`)
...
CREATE TABLE `mir_c2_disp_penal_v1_cad` (
  ...
  CONSTRAINT `mir_c2_disp_penal_v1_cad_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3241 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Datos de DISP_PENAL v1, hoja "CAD". Generada desde la Capa 1. Sólo entran filas que superaron las validaciones bloqueantes.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_disp_penal_v1_cad`
--

LOCK TABLES `mir_c2_disp_penal_v1_cad` WRITE;
/*!40000 ALTER TABLE `mir_c2_disp_penal_v1_cad` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_disp_penal_v1_cad` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_disp_penal_v1_crc`
--

DROP TABLE IF EXISTS `mir_c2_disp_penal_v1_crc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_disp_penal_v1_crc` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_disp_penal_v1_crc_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3241 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Datos de DISP_PENAL v1, hoja "CRC". Generada desde la Capa 1. Sólo entran filas que superaron las validaciones bloqueantes.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_disp_penal_v1_crc`
--

LOCK TABLES `mir_c2_disp_penal_v1_crc` WRITE;
/*!40000 ALTER TABLE `mir_c2_disp_penal_v1_crc` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_disp_penal_v1_crc` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_disp_penal_v1_crsc`
--

DROP TABLE IF EXISTS `mir_c2_disp_penal_v1_crsc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_disp_penal_v1_crsc` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_disp_penal_v1_crsc_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3241 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Datos de DISP_PENAL v1, hoja "CRSC". Generada desde la Capa 1. Sólo entran filas que superaron las validaciones bloqueantes.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_disp_penal_v1_crsc`
--

LOCK TABLES `mir_c2_disp_penal_v1_crsc` WRITE;
/*!40000 ALTER TABLE `mir_c2_disp_penal_v1_crsc` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_disp_penal_v1_crsc` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_disp_penal_v1_guardiacomis`
--

DROP TABLE IF EXISTS `mir_c2_disp_penal_v1_guardiacomis`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_disp_penal_v1_guardiacomis` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_disp_penal_v1_guardiacomis_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3241 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Datos de DISP_PENAL v1, hoja "Guardia Comisaría". Generada desde la Capa 1. Sólo entran filas que superaron las validaciones bloqueantes.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_disp_penal_v1_guardiacomis`
--

LOCK TABLES `mir_c2_disp_penal_v1_guardiacomis` WRITE;
/*!40000 ALTER TABLE `mir_c2_disp_penal_v1_guardiacomis` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_disp_penal_v1_guardiacomis` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_disp_penal_v1_mpt`
--

DROP TABLE IF EXISTS `mir_c2_disp_penal_v1_mpt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_disp_penal_v1_mpt` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_disp_penal_v1_mpt_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3241 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Datos de DISP_PENAL v1, hoja "MPT". Generada desde la Capa 1. Sólo entran filas que superaron las validaciones bloqueantes.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_disp_penal_v1_mpt`
--

LOCK TABLES `mir_c2_disp_penal_v1_mpt` WRITE;
/*!40000 ALTER TABLE `mir_c2_disp_penal_v1_mpt` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_disp_penal_v1_mpt` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_disp_scp_v1`
--

DROP TABLE IF EXISTS `mir_c2_disp_scp_v1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_disp_scp_v1` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_disp_scp_v1_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2611 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Datos de DISP_SCP v1, hoja "M Residencial". Generada desde la Capa 1. Sólo entran filas que superaron las validaciones bloqueantes.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_disp_scp_v1`
--

LOCK TABLES `mir_c2_disp_scp_v1` WRITE;
/*!40000 ALTER TABLE `mir_c2_disp_scp_v1` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_disp_scp_v1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_errores_de_importacion`
--

DROP TABLE IF EXISTS `mir_c2_errores_de_importacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_errores_de_importacion` (
  ...
  CONSTRAINT `mir_c2_errores_de_importacion_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=383 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Motivos por los que un archivo no pudo importarse. Un archivo equivocado suele fallar por varias razones a la vez: se informan todas juntas para que el operador corrija una sola vez.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_errores_de_importacion`
--

LOCK TABLES `mir_c2_errores_de_importacion` WRITE;
/*!40000 ALTER TABLE `mir_c2_errores_de_importacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_errores_de_importacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_historial_cambios`
--

DROP TABLE IF EXISTS `mir_c2_historial_cambios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_historial_cambios` (
  ...
  CONSTRAINT `mir_c2_historial_cambios_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`),
  CONSTRAINT `mir_c2_historial_cambios_ibfk_2` FOREIGN KEY (`campo_id`) REFERENCES `mir_c1_campo` (`id`),
  CONSTRAINT `mir_c2_historial_cambios_ibfk_3` FOREIGN KEY (`observacion_id`) REFERENCES `mir_c2_observacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=204 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Correcciones sobre los datos importados, con usuario, fecha, valor anterior y valor nuevo. Responde a la pregunta: el Excel decía X y el operador puso Y. No confundir con el historial de la Capa 3, que registra la evolución del dato consolidado entre períodos.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_historial_cambios`
--

LOCK TABLES `mir_c2_historial_cambios` WRITE;
/*!40000 ALTER TABLE `mir_c2_historial_cambios` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_historial_cambios` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_importacion`
--

DROP TABLE IF EXISTS `mir_c2_importacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_importacion` (
  ...
  CONSTRAINT `mir_c2_importacion_ibfk_1` FOREIGN KEY (`presentacion_id`) REFERENCES `mir_c2_presentacion` (`id`),
  CONSTRAINT `mir_c2_importacion_ibfk_2` FOREIGN KEY (`archivo_id`) REFERENCES `mir_c1_archivo` (`id`),
  CONSTRAINT `mir_c2_importacion_ibfk_3` FOREIGN KEY (`archivo_version_id`) REFERENCES `mir_c1_archivo_version` (`id`),
  CONSTRAINT `mir_c2_importacion_ibfk_4` FOREIGN KEY (`anulada_por`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=508 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Cada intento de importación de un archivo, incluidos los que fallaron. Nunca se borra: es la trazabilidad. Permite distinguir a quien no cargó de quien intentó cargar y no pudo.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_importacion`
--

LOCK TABLES `mir_c2_importacion` WRITE;
/*!40000 ALTER TABLE `mir_c2_importacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_importacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_jurisdiccion`
--

DROP TABLE IF EXISTS `mir_c2_jurisdiccion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `mir_c2_jurisdiccion`
--
...
--
-- Table structure for table `mir_c2_legajo_nya_v1_nya`
--

DROP TABLE IF EXISTS `mir_c2_legajo_nya_v1_nya`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_legajo_nya_v1_nya` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_legajo_nya_v1_nya_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
...
--
-- Dumping data for table `mir_c2_legajo_nya_v1_nya`
--

LOCK TABLES `mir_c2_legajo_nya_v1_nya` WRITE;
/*!40000 ALTER TABLE `mir_c2_legajo_nya_v1_nya` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_legajo_nya_v1_nya` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_legajo_nya_v1_prov_dto_loc`
--

DROP TABLE IF EXISTS `mir_c2_legajo_nya_v1_prov_dto_loc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_legajo_nya_v1_prov_dto_loc` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_legajo_nya_v1_prov_dto_loc_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
...
--
-- Dumping data for table `mir_c2_legajo_nya_v1_prov_dto_loc`
--

LOCK TABLES `mir_c2_legajo_nya_v1_prov_dto_loc` WRITE;
/*!40000 ALTER TABLE `mir_c2_legajo_nya_v1_prov_dto_loc` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_legajo_nya_v1_prov_dto_loc` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_mpe_v1`
--

DROP TABLE IF EXISTS `mir_c2_mpe_v1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_mpe_v1` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_mpe_v1_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Datos de MPE v1, hoja "MPE". Generada desde la Capa 1. Sólo entran filas que superaron las validaciones bloqueantes.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_mpe_v1`
--

LOCK TABLES `mir_c2_mpe_v1` WRITE;
/*!40000 ALTER TABLE `mir_c2_mpe_v1` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_mpe_v1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_mpe_v2`
--

DROP TABLE IF EXISTS `mir_c2_mpe_v2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_mpe_v2` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_mpe_v2_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
...
--
-- Dumping data for table `mir_c2_mpe_v2`
--

LOCK TABLES `mir_c2_mpe_v2` WRITE;
/*!40000 ALTER TABLE `mir_c2_mpe_v2` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_mpe_v2` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_mpi_v1`
--

DROP TABLE IF EXISTS `mir_c2_mpi_v1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_mpi_v1` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_mpi_v1_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2371 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Datos de MPI v1, hoja "MPI". Generada desde la Capa 1. Sólo entran filas que superaron las validaciones bloqueantes.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_mpi_v1`
--

LOCK TABLES `mir_c2_mpi_v1` WRITE;
/*!40000 ALTER TABLE `mir_c2_mpi_v1` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_mpi_v1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_mpj_dae_v1_dae`
--

DROP TABLE IF EXISTS `mir_c2_mpj_dae_v1_dae`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_mpj_dae_v1_dae` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_mpj_dae_v1_dae_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1921 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Datos de MPJ_DAE v1, hoja "DAE". Generada desde la Capa 1. Sólo entran filas que superaron las validaciones bloqueantes.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_mpj_dae_v1_dae`
--

LOCK TABLES `mir_c2_mpj_dae_v1_dae` WRITE;
/*!40000 ALTER TABLE `mir_c2_mpj_dae_v1_dae` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_mpj_dae_v1_dae` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_mpj_dae_v1_mpj`
--

DROP TABLE IF EXISTS `mir_c2_mpj_dae_v1_mpj`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_mpj_dae_v1_mpj` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Identificador interno.',
  `importacion_id` bigint NOT NULL COMMENT 'Importación a la que pertenece la fila.',
  `numero_fila` int NOT NULL COMMENT 'Número de fila en el Excel, tal como lo ve quien completa la planilla.',
  `estado` enum('VALIDA','CON_ADVERTENCIA','EDITADA') NOT NULL DEFAULT 'VALIDA' COMMENT 'Resultado de la validación de la fila. Las filas con bloqueantes no llegan a incorporarse.',
  ...
  CONSTRAINT `mir_c2_mpj_dae_v1_mpj_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1921 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Datos de MPJ_DAE v1, hoja "MPJ". Generada desde la Capa 1. Sólo entran filas que superaron las validaciones bloqueantes.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_mpj_dae_v1_mpj`
--

LOCK TABLES `mir_c2_mpj_dae_v1_mpj` WRITE;
/*!40000 ALTER TABLE `mir_c2_mpj_dae_v1_mpj` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_mpj_dae_v1_mpj` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_observacion`
--

DROP TABLE IF EXISTS `mir_c2_observacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_observacion` (
  ...
  KEY `campo_id` (`campo_id`),
  CONSTRAINT `mir_c2_observacion_ibfk_1` FOREIGN KEY (`presentacion_id`) REFERENCES `mir_c2_presentacion` (`id`),
  CONSTRAINT `mir_c2_observacion_ibfk_2` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`),
  CONSTRAINT `mir_c2_observacion_ibfk_3` FOREIGN KEY (`campo_id`) REFERENCES `mir_c1_campo` (`id`)
...
--
-- Dumping data for table `mir_c2_observacion`
--

LOCK TABLES `mir_c2_observacion` WRITE;
/*!40000 ALTER TABLE `mir_c2_observacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_observacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_periodo`
--

DROP TABLE IF EXISTS `mir_c2_periodo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `mir_c2_periodo`
--

LOCK TABLES `mir_c2_periodo` WRITE;
/*!40000 ALTER TABLE `mir_c2_periodo` DISABLE KEYS */;
INSERT INTO `mir_c2_periodo` VALUES (1,'2026_T1',2026,1,'2026-01-01','2026-03-31','ABIERTO',0,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `mir_c2_periodo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_periodo_archivo`
--

DROP TABLE IF EXISTS `mir_c2_periodo_archivo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_periodo_archivo` (
  ...
  KEY `archivo_version_id` (`archivo_version_id`),
  CONSTRAINT `mir_c2_periodo_archivo_ibfk_1` FOREIGN KEY (`periodo_id`) REFERENCES `mir_c2_periodo` (`id`),
  CONSTRAINT `mir_c2_periodo_archivo_ibfk_2` FOREIGN KEY (`archivo_version_id`) REFERENCES `mir_c1_archivo_version` (`id`)
...
--
-- Dumping data for table `mir_c2_periodo_archivo`
--

LOCK TABLES `mir_c2_periodo_archivo` WRITE;
/*!40000 ALTER TABLE `mir_c2_periodo_archivo` DISABLE KEYS */;
INSERT INTO `mir_c2_periodo_archivo` VALUES (1,1,1),(2,1,2),(4,1,3),(8,1,4),(5,1,5);
/*!40000 ALTER TABLE `mir_c2_periodo_archivo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_presentacion`
--

DROP TABLE IF EXISTS `mir_c2_presentacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_presentacion` (
  ...
  CONSTRAINT `mir_c2_presentacion_ibfk_1` FOREIGN KEY (`periodo_id`) REFERENCES `mir_c2_periodo` (`id`),
  CONSTRAINT `mir_c2_presentacion_ibfk_2` FOREIGN KEY (`jurisdiccion_id`) REFERENCES `mir_c2_jurisdiccion` (`id`),
  CONSTRAINT `mir_c2_presentacion_ibfk_3` FOREIGN KEY (`reemplaza_a`) REFERENCES `mir_c2_presentacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=520 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Presentación de una jurisdicción para un período. Agrupa las importaciones de los distintos archivos.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_presentacion`
--

LOCK TABLES `mir_c2_presentacion` WRITE;
/*!40000 ALTER TABLE `mir_c2_presentacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_presentacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c2_reglas_incumplidas`
--

DROP TABLE IF EXISTS `mir_c2_reglas_incumplidas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mir_c2_reglas_incumplidas` (
  ...
  KEY `campo_id` (`campo_id`),
  KEY `regla_id` (`regla_id`),
  CONSTRAINT `mir_c2_reglas_incumplidas_ibfk_1` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`),
  CONSTRAINT `mir_c2_reglas_incumplidas_ibfk_2` FOREIGN KEY (`campo_id`) REFERENCES `mir_c1_campo` (`id`),
  CONSTRAINT `mir_c2_reglas_incumplidas_ibfk_3` FOREIGN KEY (`regla_id`) REFERENCES `mir_c1_regla` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11968 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Validaciones no superadas en un archivo que SÍ fue admitido. Una fila por incumplimiento, con su ubicación exacta.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mir_c2_reglas_incumplidas`
--

LOCK TABLES `mir_c2_reglas_incumplidas` WRITE;
/*!40000 ALTER TABLE `mir_c2_reglas_incumplidas` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c2_reglas_incumplidas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_cambio`
--
...
CREATE TABLE `mir_c3_cambio` (
  ...
  CONSTRAINT `fk_cambio_pres` FOREIGN KEY (`presentacion_id`) REFERENCES `mir_c2_presentacion` (`id`)
...
--
-- Dumping data for table `mir_c3_cambio`
--

LOCK TABLES `mir_c3_cambio` WRITE;
/*!40000 ALTER TABLE `mir_c3_cambio` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_cambio` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_coincidencia`
--
...
CREATE TABLE `mir_c3_coincidencia` (
  ...
  CONSTRAINT `fk_coincidencia_imp` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`),
  CONSTRAINT `fk_coincidencia_persona` FOREIGN KEY (`persona_candidata_id`) REFERENCES `mir_c3_persona` (`id`)
...
--
-- Dumping data for table `mir_c3_coincidencia`
--

LOCK TABLES `mir_c3_coincidencia` WRITE;
/*!40000 ALTER TABLE `mir_c3_coincidencia` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_coincidencia` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_disp_alcance_territorial`
--
...
CREATE TABLE `mir_c3_disp_alcance_territorial` (
  ...
  CONSTRAINT `fk_alcance_disp` FOREIGN KEY (`dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`)
...
--
-- Dumping data for table `mir_c3_disp_alcance_territorial`
--

LOCK TABLES `mir_c3_disp_alcance_territorial` WRITE;
/*!40000 ALTER TABLE `mir_c3_disp_alcance_territorial` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_disp_alcance_territorial` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_disp_cad`
--
...
CREATE TABLE `mir_c3_disp_cad` (
  ...
  CONSTRAINT `fk_disp_cad` FOREIGN KEY (`dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`)
...
--
-- Dumping data for table `mir_c3_disp_cad`
--

LOCK TABLES `mir_c3_disp_cad` WRITE;
/*!40000 ALTER TABLE `mir_c3_disp_cad` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_disp_cad` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_disp_crc`
--
...
CREATE TABLE `mir_c3_disp_crc` (
  `dispositivo_id` bigint NOT NULL,
  PRIMARY KEY (`dispositivo_id`),
  CONSTRAINT `fk_disp_crc` FOREIGN KEY (`dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`)
...
--
-- Dumping data for table `mir_c3_disp_crc`
--

LOCK TABLES `mir_c3_disp_crc` WRITE;
/*!40000 ALTER TABLE `mir_c3_disp_crc` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_disp_crc` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_disp_crsc`
--
...
CREATE TABLE `mir_c3_disp_crsc` (
  `dispositivo_id` bigint NOT NULL,
  PRIMARY KEY (`dispositivo_id`),
  CONSTRAINT `fk_disp_crsc` FOREIGN KEY (`dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`)
...
--
-- Dumping data for table `mir_c3_disp_crsc`
--

LOCK TABLES `mir_c3_disp_crsc` WRITE;
/*!40000 ALTER TABLE `mir_c3_disp_crsc` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_disp_crsc` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_disp_guardia`
--
...
CREATE TABLE `mir_c3_disp_guardia` (
  `dispositivo_id` bigint NOT NULL,
  PRIMARY KEY (`dispositivo_id`),
  CONSTRAINT `fk_disp_guardia` FOREIGN KEY (`dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`)
...
--
-- Dumping data for table `mir_c3_disp_guardia`
--

LOCK TABLES `mir_c3_disp_guardia` WRITE;
/*!40000 ALTER TABLE `mir_c3_disp_guardia` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_disp_guardia` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_disp_mpt`
--
...
CREATE TABLE `mir_c3_disp_mpt` (
  `dispositivo_id` bigint NOT NULL,
  PRIMARY KEY (`dispositivo_id`),
  CONSTRAINT `fk_disp_mpt` FOREIGN KEY (`dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`)
...
--
-- Dumping data for table `mir_c3_disp_mpt`
--

LOCK TABLES `mir_c3_disp_mpt` WRITE;
/*!40000 ALTER TABLE `mir_c3_disp_mpt` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_disp_mpt` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_disp_residencial`
--
...
CREATE TABLE `mir_c3_disp_residencial` (
  `dispositivo_id` bigint NOT NULL,
  PRIMARY KEY (`dispositivo_id`),
  CONSTRAINT `fk_disp_resid` FOREIGN KEY (`dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`)
...
--
-- Dumping data for table `mir_c3_disp_residencial`
--

LOCK TABLES `mir_c3_disp_residencial` WRITE;
/*!40000 ALTER TABLE `mir_c3_disp_residencial` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_disp_residencial` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_dispositivo`
--
...
CREATE TABLE `mir_c3_dispositivo` (
  ...
  CONSTRAINT `fk_dispositivo_jur` FOREIGN KEY (`jurisdiccion_id`) REFERENCES `mir_c2_jurisdiccion` (`id`)
...
--
-- Dumping data for table `mir_c3_dispositivo`
--

LOCK TABLES `mir_c3_dispositivo` WRITE;
/*!40000 ALTER TABLE `mir_c3_dispositivo` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_dispositivo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_familia_acogimiento`
--
...
CREATE TABLE `mir_c3_familia_acogimiento` (
  ...
  CONSTRAINT `fk_familia_jur` FOREIGN KEY (`jurisdiccion_id`) REFERENCES `mir_c2_jurisdiccion` (`id`)
...
--
-- Dumping data for table `mir_c3_familia_acogimiento`
--

LOCK TABLES `mir_c3_familia_acogimiento` WRITE;
/*!40000 ALTER TABLE `mir_c3_familia_acogimiento` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_familia_acogimiento` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_medida_dae`
--
...
CREATE TABLE `mir_c3_medida_dae` (
  ...
  CONSTRAINT `fk_dae_disp` FOREIGN KEY (`dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`),
  CONSTRAINT `fk_dae_jur` FOREIGN KEY (`jurisdiccion_id`) REFERENCES `mir_c2_jurisdiccion` (`id`),
  CONSTRAINT `fk_dae_nya` FOREIGN KEY (`nino_adolescente_id`) REFERENCES `mir_c3_nino_adolescente` (`id`),
  CONSTRAINT `fk_dae_pres` FOREIGN KEY (`presentacion_id`) REFERENCES `mir_c2_presentacion` (`id`)
...
--
-- Dumping data for table `mir_c3_medida_dae`
--

LOCK TABLES `mir_c3_medida_dae` WRITE;
/*!40000 ALTER TABLE `mir_c3_medida_dae` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_medida_dae` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_medida_mpe`
--
...
CREATE TABLE `mir_c3_medida_mpe` (
  ...
  CONSTRAINT `fk_mpe_disp` FOREIGN KEY (`dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`),
  CONSTRAINT `fk_mpe_familia` FOREIGN KEY (`familia_id`) REFERENCES `mir_c3_familia_acogimiento` (`id`),
  CONSTRAINT `fk_mpe_familia_amp` FOREIGN KEY (`familia_ampliada_id`) REFERENCES `mir_c3_familia_acogimiento` (`id`),
  CONSTRAINT `fk_mpe_jur` FOREIGN KEY (`jurisdiccion_id`) REFERENCES `mir_c2_jurisdiccion` (`id`),
  CONSTRAINT `fk_mpe_nya` FOREIGN KEY (`nino_adolescente_id`) REFERENCES `mir_c3_nino_adolescente` (`id`),
  CONSTRAINT `fk_mpe_pres_act` FOREIGN KEY (`presentacion_actualizacion_id`) REFERENCES `mir_c2_presentacion` (`id`),
  CONSTRAINT `fk_mpe_pres_alta` FOREIGN KEY (`presentacion_alta_id`) REFERENCES `mir_c2_presentacion` (`id`)
...
--
-- Dumping data for table `mir_c3_medida_mpe`
--

LOCK TABLES `mir_c3_medida_mpe` WRITE;
/*!40000 ALTER TABLE `mir_c3_medida_mpe` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_medida_mpe` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_medida_mpi`
--
...
CREATE TABLE `mir_c3_medida_mpi` (
  ...
  CONSTRAINT `fk_mpi_jur` FOREIGN KEY (`jurisdiccion_id`) REFERENCES `mir_c2_jurisdiccion` (`id`),
  CONSTRAINT `fk_mpi_nya` FOREIGN KEY (`nino_adolescente_id`) REFERENCES `mir_c3_nino_adolescente` (`id`),
  CONSTRAINT `fk_mpi_pres_act` FOREIGN KEY (`presentacion_actualizacion_id`) REFERENCES `mir_c2_presentacion` (`id`),
  CONSTRAINT `fk_mpi_pres_alta` FOREIGN KEY (`presentacion_alta_id`) REFERENCES `mir_c2_presentacion` (`id`),
  CONSTRAINT `fk_mpi_referente` FOREIGN KEY (`referente_adulto_id`) REFERENCES `mir_c3_referente_adulto` (`id`),
  CONSTRAINT `fk_mpi_unidad` FOREIGN KEY (`unidad_interviniente_id`) REFERENCES `mir_c3_unidad_interviniente` (`id`)
...
--
-- Dumping data for table `mir_c3_medida_mpi`
--

LOCK TABLES `mir_c3_medida_mpi` WRITE;
/*!40000 ALTER TABLE `mir_c3_medida_mpi` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_medida_mpi` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_medida_mpj`
--
...
CREATE TABLE `mir_c3_medida_mpj` (
  ...
  CONSTRAINT `fk_mpj_disp` FOREIGN KEY (`dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`),
  CONSTRAINT `fk_mpj_disp_dest` FOREIGN KEY (`destino_dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`),
  CONSTRAINT `fk_mpj_disp_proc` FOREIGN KEY (`procedencia_dispositivo_id`) REFERENCES `mir_c3_dispositivo` (`id`),
  CONSTRAINT `fk_mpj_jur` FOREIGN KEY (`jurisdiccion_id`) REFERENCES `mir_c2_jurisdiccion` (`id`),
  CONSTRAINT `fk_mpj_nya` FOREIGN KEY (`nino_adolescente_id`) REFERENCES `mir_c3_nino_adolescente` (`id`),
  CONSTRAINT `fk_mpj_pres_act` FOREIGN KEY (`presentacion_actualizacion_id`) REFERENCES `mir_c2_presentacion` (`id`),
  CONSTRAINT `fk_mpj_pres_alta` FOREIGN KEY (`presentacion_alta_id`) REFERENCES `mir_c2_presentacion` (`id`)
...
--
-- Dumping data for table `mir_c3_medida_mpj`
--

LOCK TABLES `mir_c3_medida_mpj` WRITE;
/*!40000 ALTER TABLE `mir_c3_medida_mpj` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_medida_mpj` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_nino_adolescente`
--
...
CREATE TABLE `mir_c3_nino_adolescente` (
  ...
  CONSTRAINT `fk_nya_persona` FOREIGN KEY (`persona_id`) REFERENCES `mir_c3_persona` (`id`)
...
--
-- Dumping data for table `mir_c3_nino_adolescente`
--

LOCK TABLES `mir_c3_nino_adolescente` WRITE;
/*!40000 ALTER TABLE `mir_c3_nino_adolescente` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_nino_adolescente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_nya_id_provincial`
--
...
CREATE TABLE `mir_c3_nya_id_provincial` (
  ...
  CONSTRAINT `fk_id_prov_jur` FOREIGN KEY (`jurisdiccion_id`) REFERENCES `mir_c2_jurisdiccion` (`id`),
  CONSTRAINT `fk_id_prov_nya` FOREIGN KEY (`nino_adolescente_id`) REFERENCES `mir_c3_nino_adolescente` (`id`)
...
--
-- Dumping data for table `mir_c3_nya_id_provincial`
--

LOCK TABLES `mir_c3_nya_id_provincial` WRITE;
/*!40000 ALTER TABLE `mir_c3_nya_id_provincial` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_nya_id_provincial` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_origen`
--
...
CREATE TABLE `mir_c3_origen` (
  ...
  CONSTRAINT `fk_origen_imp` FOREIGN KEY (`importacion_id`) REFERENCES `mir_c2_importacion` (`id`),
  CONSTRAINT `fk_origen_pres` FOREIGN KEY (`presentacion_id`) REFERENCES `mir_c2_presentacion` (`id`)
...
--
-- Dumping data for table `mir_c3_origen`
--

LOCK TABLES `mir_c3_origen` WRITE;
/*!40000 ALTER TABLE `mir_c3_origen` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_origen` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_persona`
--
...
--
-- Dumping data for table `mir_c3_persona`
--

LOCK TABLES `mir_c3_persona` WRITE;
/*!40000 ALTER TABLE `mir_c3_persona` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_persona` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_precedencia`
--
...
--
-- Dumping data for table `mir_c3_precedencia`
--

LOCK TABLES `mir_c3_precedencia` WRITE;
/*!40000 ALTER TABLE `mir_c3_precedencia` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_precedencia` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_referente_adulto`
--
...
CREATE TABLE `mir_c3_referente_adulto` (
  ...
  CONSTRAINT `fk_referente_persona` FOREIGN KEY (`persona_id`) REFERENCES `mir_c3_persona` (`id`)
...
--
-- Dumping data for table `mir_c3_referente_adulto`
--

LOCK TABLES `mir_c3_referente_adulto` WRITE;
/*!40000 ALTER TABLE `mir_c3_referente_adulto` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_referente_adulto` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_unidad_alias`
--
...
CREATE TABLE `mir_c3_unidad_alias` (
  ...
  CONSTRAINT `fk_alias_jur` FOREIGN KEY (`jurisdiccion_id`) REFERENCES `mir_c2_jurisdiccion` (`id`),
  CONSTRAINT `fk_alias_unidad` FOREIGN KEY (`unidad_interviniente_id`) REFERENCES `mir_c3_unidad_interviniente` (`id`)
...
--
-- Dumping data for table `mir_c3_unidad_alias`
--

LOCK TABLES `mir_c3_unidad_alias` WRITE;
/*!40000 ALTER TABLE `mir_c3_unidad_alias` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_unidad_alias` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mir_c3_unidad_interviniente`
--
...
CREATE TABLE `mir_c3_unidad_interviniente` (
  ...
  CONSTRAINT `fk_unidad_jur` FOREIGN KEY (`jurisdiccion_id`) REFERENCES `mir_c2_jurisdiccion` (`id`)
...
--
-- Dumping data for table `mir_c3_unidad_interviniente`
--

LOCK TABLES `mir_c3_unidad_interviniente` WRITE;
/*!40000 ALTER TABLE `mir_c3_unidad_interviniente` DISABLE KEYS */;
/*!40000 ALTER TABLE `mir_c3_unidad_interviniente` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-09-17 12:09:05
