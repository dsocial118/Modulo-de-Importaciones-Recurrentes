...
Nueve pasos, de la carga de la entidad a la consolidación nacional. El criterio es
que reduzca la edición manual y **mantenga la responsabilidad de la entidad sobre
...
| **Cierre de carga** | El responsable de la entidad declara terminada la carga del período y la envía a revisión nacional |
| **Observación** | Aclaraciones y dudas del revisor técnico nacional sobre los datos cargados |
| **Presentación** | El acto formal por el cual la entidad declara que esos son los datos del período, una vez que el revisor resolvió sus observaciones y habilitó la opción. Genera un comprobante para remitir por GDE |
...
|---|---|---|
| **1. Carga de dispositivos.** La entidad carga primero las bases de dispositivos residenciales y penales. SISOC valida y asigna los ID de dispositivo. | Operador de la entidad | Cargar archivos, consultar errores y preparar correcciones. |
| **2. Carga de las nóminas.** La entidad carga los archivos que dependen de los anteriores. El sistema identifica los registros y sus relaciones. | Operador de la entidad | Ídem. Los dispositivos deben estar cargados antes que las nóminas que los referencian. |
...
| **5. Corrección.** Los errores **bloqueantes** se corrigen en el Excel y el archivo se vuelve a importar. Las **advertencias** se resuelven dentro del sistema, editando el dato o justificándolo. | Operador de la entidad | Corregir. Toda edición queda registrada con usuario, fecha, valor anterior y valor nuevo. |
| **6. Cierre de carga.** El responsable de la entidad declara terminada la carga del período y la envía a revisión nacional. | Responsable de la entidad | Revisar lo cargado por el operador y decidir cuándo está en condiciones de revisarse. |
| **7. Revisión nacional.** El revisor formula observaciones sin modificar los datos de la entidades. Si hay observaciones, la carga vuelve a la entidad; si no las hay, habilita la presentación. | Revisor técnico nacional | Revisar calidad, formular observaciones y habilitar la presentación. **No modifica datos de la entidades.** |
| **8. Subsanación.** La entidad responde las observaciones editando en el sistema y vuelve a cerrar la carga. | Operador de la entidad edita · Responsable de la entidad cierra | Resolver cada observación dejando constancia. |
| **9. Presentación y consolidación.** El responsable de la entidad presenta formalmente el período y descarga el comprobante para remitir por GDE. Los datos de la Capa 2 se incorporan a la base consolidada de la Capa 3. | Responsable de la entidad presenta · SISOC consolida | Formalizar la presentación del período. |
...
<!-- COMENTARIO: los pasos 1 y 2 pueden variar según cómo se resuelva el
     ...
     los archivos de referencia y los de datos. No altera la lógica del circuito ni la
...
5. **El cierre de carga es responsabilidad del responsable de la entidad**, no del
   operador. Es la declaración de que el período está en condiciones de revisarse.
6. **El nivel nacional no modifica datos de la entidades.** Sólo formula
...
entrega** en tiempo y forma. Constituye un resguardo para la entidad.

El responsable de la entidad lo descarga, lo remite por GDE e incorpora al sistema
...
## Continuidad de los registros entre períodos

Una persona informada en un período puede no aparecer en el siguiente. En
principio es esperable: el registro concluyó.

La situación a atender es otra: **un registro informado como vigente —sin fecha de
...
comparar con el período anterior, el sistema identifica esos registros y los presenta a
...
> **Alcance del rol de responsable de la entidad.** Se propone que pueda realizar
